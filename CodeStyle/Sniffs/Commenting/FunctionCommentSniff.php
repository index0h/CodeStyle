 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class CodeStyle_Sniffs_Commenting_FunctionCommentSniff implements PHP_CodeSniffer_Sniff
{
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        if (empty($long) === false) {
            ...
            $testLong = trim($long);
            if ((preg_match('|\w|u', $testLong[0]) === 0) || (strtoupper($testLong[0]) !== $testLong[0])) {
        ...
        if ((preg_match('|\w|u', $testShort[0]) === 0) || (strtoupper($testShort[0]) !== $testShort[0])) {
        ...
        if (empty($params) === false) {
            ...
            foreach ($params as $param) {
                ...
                if ($paramComment === '') {
                    ...
                    if ((preg_match('|\w|u', $firstChar) === 0) || (strtoupper($firstChar) !== $firstChar)) {
