...
/**
 * CodeStyle_Sniffs_Commenting_BlockCommentSniff.
 *
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class CodeStyle_Sniffs_Commenting_BlockCommentSniff implements PHP_CodeSniffer_Sniff
{
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        if (trim($tokens[$commentLines[1]]['content']) === '') {
            ...
            if ((preg_match('|\w|u', $commentText[0]) === 0) || (strtoupper($commentText[0]) !== $commentText[0])) {
